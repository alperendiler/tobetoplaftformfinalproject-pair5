...
export default function Announcements({}: Props) {
  return (
    ...
    <div className="dropdown">
      <button className="white-filter dropdown-toggle ms-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">Tür</button>
      <ul className="dropdown-menu new-filter">
        <li className="filter-checkbox-item">
          <div className="form-check">
            ...
            <label className="form-check-label" htmlFor="typeNews">Haber</label>
          </div>
        </li>
        <li className="filter-checkbox-item">
          <div className="form-check">
            <input className="form-check-input" type="checkbox" id="typeAnnouncement" />
            <label className="form-check-label" htmlFor="typeAnnouncement">Duyuru</label>
          </div>
        </li>
      </ul>
    </div>
    ...
    <div className="d-flex align-items-center rw-100 gap-3">
      <div className="dropdown">
        <button className="white-filter dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Sıralama</button>
        <ul className="dropdown-menu new-filter">
          <li><a className="dropdown-item createdAt active">Tarihe Göre (Y-E)</a></li>
          <li><a className="dropdown-item createdAt ">Tarihe Göre (E-Y)</a></li>
        </ul>
      </div>
