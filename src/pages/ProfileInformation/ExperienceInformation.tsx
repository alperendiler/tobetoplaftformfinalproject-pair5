            ...
            >
              ...
              <div className="row">
                  ...
                  <div className="col-12 col-md-6">
                    <FormikInput name="company" label="Kurum Adı*" placeholder="Kampüs 365" />
            
                 
                </div>
                  <div className="col-12 col-md-6">
                    <FormikInput name="position" label="Pozisyon*" placeholder="Front-End Developer" />
            
                  </div>
                  <div className="col-12 col-md-6">
                    <FormikInput name="sector" label="Sektör*" placeholder="Yazılım"/>
              ...
              &nbsp;Çalışmaya hala devam ediyorum.
                  ...
                  <div className="col-12 col-md-12 mb-6">
                    <FormikInput    className="no-resize" as="textarea" name="jobDescription" label="İş Açıklaması" />
